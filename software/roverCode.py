...
class MotorControlApp(ctk.CTk):
    def __init__(self):
        ...
        # Create a parent frame to hold both control and velocity frames side-by-side
        self.main_frame = ctk.CTkFrame(self)
        self.main_frame.pack(pady=10)
        self.main_label = ctk.CTkLabel(self.main_frame, text="Controls", font=("Arial", 16))
        self.main_label.pack()


        # Velocity control frame on the right
        self.velocity_frame = ctk.CTkFrame(self.main_frame)
        self.velocity_frame.pack(side="right", padx=20, pady=10)
        ...
        self.controls_frame.pack(side="left", padx=20, pady=10)

        self.btn_w = ctk.CTkButton(self.controls_frame, text="↑ Forward", width=100)
        ...
        self.btn_z = ctk.CTkButton(self.controls_frame, text="↓ Backward", width=100)
        ...
        self.btn_q = ctk.CTkButton(self.controls_frame, text="↺ Rotate CCW", width=100)
        ...
        self.btn_e = ctk.CTkButton(self.controls_frame, text="↻ Rotate CW", width=100)
        ...
        self.btn_stop = ctk.CTkButton(self.controls_frame, text="■ Stop", command=self.stop, width=100)
